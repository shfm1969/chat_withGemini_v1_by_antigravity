...
Please communicate and generate all documentation in Traditional Chinese (正體中文). Keep technical terms (like API, SDK, JSON) in English. If some KEYWORD like "SHALL" or "MUST" is used, please keep it in English. 
